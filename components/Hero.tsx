...
const Hero = ({ categories }: any) => {
 ...
 overflow-hidden  
bg-cover bg-blend-multiply bg-black/60  bg-fixed h-screen`}
      />
      <div
        className={` hidden sm:block animate-fade overflow-hidden  bg-cover bg-blend-multiply bg-black/70  h-screen`}
        style={{
          backgroundImage: `url(${
