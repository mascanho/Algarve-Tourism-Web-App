...
const Hero = () => {
  return (
    <section
      id="search"
      className="mx-auto overflow-clip sm:bg-gradient-to-r from-neutral-100 to-stone-200  w-full space-y-2 sm:h-full rounded-b-[100px] z-0 sm:space-y-4 flex flex-wrap flex-col justify-center sm:shadow-md pt-10 sm:pb-20 sm:pt-12"
    >
