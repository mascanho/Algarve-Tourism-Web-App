...
const Hero = ({ categories }: any) => {
  ...
  return (
    <>
      <div
        className={`sm:hidden  animate-fade overflow-x-hidden  bg-blend-multiply bg-black/60 bg-[url("/images/bg-mobile.webp")] bg-cover bg-fixed   h-screen w-screen min-h-screen min-w-screen`}
      />
      <div
