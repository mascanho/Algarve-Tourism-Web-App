...
function Hero() {
  return (
    <>
      <div className=" bg-[url('https://rare-gallery.com/uploads/posts/504981-Public-domain.jpg')]  h-screen overflow-hidden -mt-16 bg-cover bg-blend-multiply bg-black/30 " />
