...
const Hero = ({ categories }: any) => {
  ...
  return (
    <>
      <div
        className={`animate-fade bg-[url('https://images.unsplash.com/photo-1607419977878-5b1099c99715?q=80&w=1970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] 
