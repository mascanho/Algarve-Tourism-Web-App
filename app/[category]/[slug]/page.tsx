...
export default async function Home(props: any, req: any) {
  ...
  return (
    <>
      <section className="overflow-hidden pt-16 sm:mt-0 bg-transparent rounded-lg text-left pb-16 sm:px-4 md:w-full md:px-6 lg:px-6 xl:pr-0 space-y-4  md:max-w-4xl lg:max-w-7xl lg:pl-6  mb-2 text-black">
