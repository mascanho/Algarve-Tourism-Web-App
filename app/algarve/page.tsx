...
function page() {
  return (
    <section className="max-w-7xl mx-auto sm:mt-20">
      ...
      <div className="grid sm:grid-cols-3 mt-10 sm:mt-20 sm:gap-x-40 mx-auto w-full sm:gap-y-20 gap-y-8 max-w-7xl justify-stretch place-items-center  place-content-between">
