...
function page(props: any) {
  return (
    <section className="max-w-7xl mx-auto sm:mt-20 sm:px-3">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-10 sm:mt-12 sm:gap-x-4 overflow-hidden mx-auto w-11/12 sm:w-full sm:gap-y-8 gap-y-8 max-w-7xl justify-stretch place-items-center  place-content-between">
