...
const CardCity = ({
  ...
  return (
    <Link href={`/${type || "algarve"}/${slug}`}>
      <div className="card sm:w-[100%] sm:h-52 md:w-[360px] lg:w-[320px] xl:w-[400px] xl:h-72 lg:h-60 sm:h-72 mx-auto bg-base-100 shadow-xl  overflow-hidden group">
